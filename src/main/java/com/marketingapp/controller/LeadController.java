...
public class LeadController {
	...
	public String saveLeadData(@ModelAttribute("lead") Lead lead, ModelMap model) {
		...
		emailService.sendSimpleMessage("prasannbapuri@gmail.com", "Test", "Welcome Test Email");
	...
	//@RequestMapping("/savelead")
	//public String saveLeadData(@RequestParam("id") long id,@RequestParam("firstName") String firstName,@RequestParam("lastName") String lastName,@RequestParam("email") String email,@RequestParam("city") String city,@RequestParam("mobile") String mobile, ModelMap model) {
	//	Lead l = new Lead();
